...
const CampusLogin = () => {
  ...
  const demoLogin = (demoRole: "student" | "professor") => {
    if (demoRole === "student") {
      login("priya@campus.edu", "demo");
    } else {
      login("ananya@campus.edu", "demo");
    }
        ...
        <div className="mb-6 space-y-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-border bg-card py-2.5 text-sm font-semibold text-foreground transition-all hover:border-primary hover:bg-primary/5"
            >
            ...
            <button
              ...
              className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-border bg-card py-2.5 text-sm font-semibold text-foreground transition-all hover:border-accent hover:bg-accent/5"
            >
                ...
                <div className="flex gap-2">
                  {(["student", "professor"] as const).map((r) => (
                    <button key={r} type="button" onClick={() => setRole(r)}
                      className={`flex-1 rounded-lg border py-2 text-sm font-semibold capitalize transition-all ${role === r ? "border-primary bg-primary/10 text-primary" : "border-border text-muted-foreground hover:border-primary/50"}`}>
                      {r}
                    </button>
                  ))}
                </div>
